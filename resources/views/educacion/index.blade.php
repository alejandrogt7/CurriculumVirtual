        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div id="form-educacion" class="p-8 bg-white dark:bg-gray-800 shadow-xl sm:rounded-lg border-t-8 border-indigo-600">
                ...
                <form method="POST" action="{{ $eduEdit ? route('educacion.update', $eduEdit) : route('educacion.store') }}" class="space-y-6">
                    ...
                    <div>
                        <x-input-label value="Descripción Adicional" />
                        <textarea name="descripcion" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 rounded-md shadow-sm" rows="3">{{ old('descripcion', $eduEdit->descripcion ?? '') }}</textarea>
                    </div>
